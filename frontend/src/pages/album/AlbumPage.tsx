...
const AlbumPage = () => {
    ...
    const colorVariants = [
      "from-[#4CAF50]/80", // green
      "from-[#2196F3]/80", // blue
      "from-[#F44336]/80", // red
      "from-[#9C27B0]/80", // purple
      "from-[#FF9800]/80", // orange
    ];
    const randomColor =colorVariants[Math.floor(Math.random() * colorVariants.length)];

      //fetch songs of album
    useEffect(() => {
    ...
    const handlePlayAlbum = () => {
      ...
      if(isCurrentAlbumPlaying)togglePlay();
        ...
        //start playing album from the begining
  ...
  return (
    <div className="h-full ">
      <ScrollArea className="h-full rounded-md">
        {/* main content */}
        <div className="relatice min-h-full ">
          {/* bg gradient */}
          <div
          ...
          <div className="px-6 pb-4 flex items-center gap-6">
            <Button
              ...
              className="w-14 h-14 z-20 rounded-full bg-green-500 hover:bg-green-400 hover:scale-105 transition-all"
            >
              {isPlaying &&
